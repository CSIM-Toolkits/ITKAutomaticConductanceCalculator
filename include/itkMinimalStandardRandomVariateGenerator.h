...
#include "AutomaticConductanceCalculatorExport.h"
 ...
 *
 * \ingroup AutomaticConductanceCalculator
 */
class AutomaticConductanceCalculator_EXPORT MinimalStandardRandomVariateGenerator:
